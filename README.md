# Functional Python [![](https://github.com/agemeda/functional-python/workflows/tests/badge.svg)](https://github.com/agemeda/functional-python/actions?query=workflow%3Atests)
